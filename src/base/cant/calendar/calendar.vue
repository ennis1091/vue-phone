<template>
  <div class="calendar-all">
    ...
    <table cellpadding="5">
      <thead>
        <tr>
          <td v-for="(week, index) in weeks" class="week" :key="index">
            {{ week }}
          </td>
        </tr>
      </thead>
...
.calendar-all td.week {
  font-size: 10px;
  pointer-events: none !important;
  cursor: default !important;
}
.calendar-all td.disabled {
  color: #ccc;
  pointer-events: none !important;
  cursor: default !important;
}
.calendar-all td.disabled div {
  color: #ccc;
}
.calendar-all td span {
  display: block;
  height: 26px;
  font-size: 16px;
  line-height: 26px;
...
.calendar-all td:not(.selected) span:not(.red):hover {
  background: #f3f8fa;
  color: #444;
}
.calendar-all td:not(.selected) span.red:hover {
  background: #f9efef;
}

.calendar-all td:not(.disabled) span.red {
  color: #ea6151;
}
.calendar-all td.selected span {
  background-color: #f88c00;
  color: #fff;
}
.calendar-all td .text {
  position: absolute;
  top: 28px;
  left: 0;
  right: 0;
...
.calendar-all td .isGregorianFestival,
.calendar td .isLunarFestival {
  color: #ea6151;
}
.calendar-all td.selected span.red {
  background-color: #f88c00;
  color: #fff;
}
.calendar-all td.selected span.red:hover {
  background-color: #f88c00;
  color: #fff;
}
.calendar-all thead td {
